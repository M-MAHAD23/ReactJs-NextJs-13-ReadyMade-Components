...
function Login() {
    ...
    const handleSend = () => {
        ...
        if (email === '' || password === '') {
            setErrorMessage('Please enter both of your email and password.');
        } else {
                ...
                <form className='max-w-[400px] w-full mx-auto rounded-lg p-8 px-8 border border-solid border-1 border-indigo-500 relative'>
                    ...
                    <div className="flex flex-col text-gray-400 py-2 mt-0 relative">
                        ...
                        <div className='mt-5'>
                            ...
                            <Link href="./ForgetPassword" className='absolute bottom-0 right-0 text-indigo-400 hover:text-black visited:text-purple-500' style={{ top: "calc(100% + 5px)" }}>
                    ...
                    <div className="relative mt-5">
                        ...
                        <Link href="/register" className='absolute bottom-0 right-0 text-indigo-400 hover:text-black visited:text-purple-500' style={{ top: "calc(90% + 0px)" }}>
